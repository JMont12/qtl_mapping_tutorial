...
knitr::opts_knit$set(root.dir="/Users/jake/Desktop/qtl_workshop")
```
...
grep gene Kochia_annotation_formatted.gff3 | awk '$1=="chr1"' | awk '$4>81000000' | awk '$4<93000000' > ./chr1_qtl_genes.txt

grep gene Kochia_annotation_formatted.gff3 | awk '$1=="chr1"' | awk '$4>81000000' | awk '$4<93000000' | cut -d$'\t' -f 9 | rev | cut -d '=' -f 1 | rev | sort | uniq > ./chr1_qtl_gene_names.txt

cat ./chr1_qtl_gene_names.txt
```
...
grep gene Kochia_annotation_formatted.gff3 | awk '$1=="chr6"' | awk '$4>2500000' | awk '$4<3500000' > ./chr6_qtl_genes.txt

grep gene Kochia_annotation_formatted.gff3 | awk '$1=="chr6"' | awk '$4>2500000' | awk '$4<3500000' | cut -d$'\t' -f 9 | rev | cut -d '=' -f 1 | rev | sort | uniq > ./chr6_qtl_gene_names.txt

cat ./chr6_qtl_gene_names.txt
```
